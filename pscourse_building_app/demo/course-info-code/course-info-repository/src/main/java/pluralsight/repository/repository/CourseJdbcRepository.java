package pluralsight.repository.repository;
...
public class CourseJdbcRepository implements CourseRepositoryInterface {
 //   private static final String H2_DATABASE_URL =
   //         "jdbc:h2:file:%s;AUTO_SERVER=TRUE;INIT=RUNSCRIPT FROM './db_init.sql'";

 private static final String H2_DATABASE_URL =
           "jdbc:h2:file:%s;AUTO_SERVER=TRUE;INIT=RUNSCRIPT FROM 'pscourse_building_app/db_init.sql'";
