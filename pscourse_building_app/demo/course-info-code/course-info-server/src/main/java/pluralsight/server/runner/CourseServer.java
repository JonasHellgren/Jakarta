package pluralsight.server.runner;

import pluralsight.repository.interfaces.CourseRepositoryInterface;
import pluralsight.server.controller.CourseController;
...
public class CourseServer {
    ...
    public static void main(String... args) {
        ...
        ResourceConfig config = new ResourceConfig().register(new CourseController(courseRepository));
